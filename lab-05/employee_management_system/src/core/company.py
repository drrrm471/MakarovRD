...
from src.utils.exceptions import DepartmentNotFoundError, ProjectNotFoundError, DuplicateIdError, EmployeeNotFoundError
...
class Company:
    ...
    def transfer_employee(self, employee: AbstractEmployee, from_department: Department, to_department: Department) -> None:
        """
